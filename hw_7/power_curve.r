...
# I add my new code chunk here
data <- data.frame(temp$`effect size`, temp$power,temp$group)

p<- plot_ly(temp, x=~temp$`effect size`, y=temp$power, type = 'scatter', color = temp$group, mode = 'lines')%>%
